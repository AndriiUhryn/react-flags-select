...
var ReactFlagsSelect = function (_Component) {
	...
	ReactFlagsSelect.prototype.render = function render() {
		...
		var countriesToShow = this.state.filter ? this.state.filteredCountries : this.state.countries;

		if (isSelected) {
			countriesToShow = countriesToShow.filter(function (countryCode) {
				return countryCode !== isSelected;
			});
		}
		...
		return _react2.default.createElement(
			...
			this.state.openOptions && _react2.default.createElement(
				...
				countriesToShow.map(function (countryCode) {
					return _react2.default.createElement(
						'div',
						{
							key: countryCode,
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('img', { src: require('../flags/' + countryCode.toLowerCase() + '.svg').default }),
